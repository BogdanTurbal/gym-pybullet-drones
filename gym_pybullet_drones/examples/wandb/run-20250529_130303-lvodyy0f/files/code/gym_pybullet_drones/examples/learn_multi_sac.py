#!/usr/bin/env python3
"""
train_sac_paper_based.py - UPDATED to use SAC with paper-based reward function
...
DEFAULT_ACT           = ActionType('rpm')  # RPM actions work great with SAC
DEFAULT_DRONES        = 4
...
def create_sac_model(env, extractor_type="matrix", features_dim=128, learning_rate=3e-4):
    """Create SAC model with custom multi-agent feature extractor"""
