...
def run(algorithm: str, output_folder: str, gui: bool, record_video: bool,
    ...
    reward_hyperparameters = {
        'lambda_1': 100.0,    # Progress reward
        'lambda_2': 0.1, #1.0,     # Perception reward
        'lambda_3': 0, #0.1,     # Perception alignment
        'lambda_4': 0.1,   # Action magnitude penalty
        'lambda_5': 0.5,    # Action smoothness penalty
        'crash_penalty': 10.0,
        'bounds_penalty': 10.0,
    }
